...
CREATE TABLE `tbl_bodegas` (
  `Pk_ID_BODEGA` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `tbl_bodegas` VALUES (1,'Bodega Central','Av. Principal 100',100,'2024-10-23',1),(2,'Bodega Norte','Calle Norte 200',80,'2024-10-23',1),(3,'Bodega Sur','Calle Sur 300',60,'2024-10-23',1);
