...
CREATE TABLE `tbl_puestos_trabajo` (
  `pk_id_puestos` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `tbl_puestos_trabajo` VALUES (1,'Trabajador','trabajador',1),(2,'Ingeniero','trabajador',1),(3,'administrador','trabajador',1);
